...
def train():
    ...
    # We expect 12 columns: res_q1..q6, res_dq1..dq6
    ...
    # Calculate a highly robust threshold: Maximum healthy loss + a generous 1% safety margin buffer
    # This severely mitigates false positives generated by peak dynamic inertia turnarounds
    max_healthy_loss = np.max(losses)
    threshold = max_healthy_loss * 1.01
    
    print(f"Maximum Healthy Loss: {max_healthy_loss:.6f}")
    print(f"Learned Robust Threshold (Max + 1%): {threshold:.6f}")
